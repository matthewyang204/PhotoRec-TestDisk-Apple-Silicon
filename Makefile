...
pkgdatadir = $(datadir)/testdisk
pkgincludedir = $(includedir)/testdisk
pkglibdir = $(libdir)/testdisk
pkglibexecdir = $(libexecdir)/testdisk
...
CONFIG_CLEAN_FILES = linux/testdisk.spec
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	...
	$(top_srcdir)/linux/testdisk.spec.in AUTHORS COPYING ChangeLog \
	INSTALL NEWS README.md THANKS config/compile \
...
ACLOCAL = ${SHELL} '/Users/matthewyang/PhotoRec-TestDisk-Apple-Silicon/config/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AUTOCONF = ${SHELL} '/Users/matthewyang/PhotoRec-TestDisk-Apple-Silicon/config/missing' autoconf
AUTOHEADER = ${SHELL} '/Users/matthewyang/PhotoRec-TestDisk-Apple-Silicon/config/missing' autoheader
AUTOMAKE = ${SHELL} '/Users/matthewyang/PhotoRec-TestDisk-Apple-Silicon/config/missing' automake-1.16
AWK = awk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2 -Wdeclaration-after-statement -Wall -Wextra -MD -Wpointer-arith -Wmissing-declarations -Wmissing-prototypes -Wstrict-prototypes -Wshadow -Wwrite-strings -W -Wcast-align -Waggregate-return -Wbad-function-cast -Wcast-qual -Wundef -Wredundant-decls -Wsign-compare -Wnested-externs -Winline -Wdisabled-optimization -Wfloat-equal -Wmissing-format-attribute -Wmultichar -Wc++-compat -Wformat=2 -Wtrampolines -Wunreachable-code -Wvla -fstack-protector-strong 
CPP = gcc -E
CPPFLAGS =  
CSCOPE = cscope
CTAGS = ctags
...
CXXFLAGS = -g -O2 -Wall -MD -Wpointer-arith -Wmissing-declarations -Wshadow -Wwrite-strings -W -Wcast-align -Wcast-qual -Wundef -Wredundant-decls -Wsign-compare -Wdisabled-optimization -Wmissing-format-attribute -Wmultichar -Wformat=2 -fvisibility=hidden -fvisibility-inlines-hidden -fPIC -Wtrampolines -Wvla -fstack-protector-strong 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
ECHO_C = \c
...
LRELEASE = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} '/Users/matthewyang/PhotoRec-TestDisk-Apple-Silicon/config/missing' makeinfo
MKDIR_P = /opt/local/bin/gmkdir -p
MOC = 
OBJEXT = o
PACKAGE = testdisk
PACKAGE_BUGREPORT = grenier@cgsecurity.org
PACKAGE_NAME = testdisk
PACKAGE_STRING = testdisk 7.2
PACKAGE_TARNAME = testdisk
PACKAGE_URL = 
PACKAGE_VERSION = 7.2
PATH_SEPARATOR = :
...
VERSION = 7.2
WINDRES = 
abs_builddir = /Users/matthewyang/PhotoRec-TestDisk-Apple-Silicon
abs_srcdir = /Users/matthewyang/PhotoRec-TestDisk-Apple-Silicon
abs_top_builddir = /Users/matthewyang/PhotoRec-TestDisk-Apple-Silicon
abs_top_srcdir = /Users/matthewyang/PhotoRec-TestDisk-Apple-Silicon
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_LRELEASE = 
ac_ct_MOC = 
...
exec_prefix = ${prefix}
fidentify_LDADD = 
fuzzerfidentify_LDADD = -fsanitize=fuzzer 
host = 
host_alias = 
host_cpu = aarch64
...
install_sh = ${SHELL} /Users/matthewyang/PhotoRec-TestDisk-Apple-Silicon/config/install-sh
...
pdfdir = ${docdir}
photorec_LDADD =  -lncurses
photorecf_LDADD =  -lncurses
prefix = /usr/local
...
linux/testdisk.spec: $(top_builddir)/config.status $(top_srcdir)/linux/testdisk.spec.in
