...
host_triplet = 
target_triplet = aarch64-apple-darwin23.6.0
subdir = .
...
ACLOCAL = ${SHELL} '/Volumes/RAMDisk 1/testdisk-7.2/config/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AUTOCONF = ${SHELL} '/Volumes/RAMDisk 1/testdisk-7.2/config/missing' autoconf
AUTOHEADER = ${SHELL} '/Volumes/RAMDisk 1/testdisk-7.2/config/missing' autoheader
AUTOMAKE = ${SHELL} '/Volumes/RAMDisk 1/testdisk-7.2/config/missing' automake-1.16
AWK = gawk
CC = gcc
...
LRELEASE = lrelease
LTLIBOBJS = 
MAKEINFO = ${SHELL} '/Volumes/RAMDisk 1/testdisk-7.2/config/missing' makeinfo
...
VERSION = 7.2
WINDRES = 
abs_builddir = /Volumes/RAMDisk 1/testdisk-7.2
abs_srcdir = /Volumes/RAMDisk 1/testdisk-7.2
abs_top_builddir = /Volumes/RAMDisk 1/testdisk-7.2
abs_top_srcdir = /Volumes/RAMDisk 1/testdisk-7.2
ac_ct_CC = gcc
ac_ct_CXX = g++
...
install_sh = ${SHELL} '/Volumes/RAMDisk 1/testdisk-7.2/config/install-sh'
